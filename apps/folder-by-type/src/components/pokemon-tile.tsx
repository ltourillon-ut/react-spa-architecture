...
import type { PokemonSummary } from '@/api/pokemon/pokemon.types'
import { TypeBadge } from '@/components/type-badge'
import { formatPokemonId } from '@/lib/pokemon'
...
export function PokemonTile({ pokemon }: PokemonTileProps) {
  ...
  function prefetchPokemonDetail() {
    void queryClient.prefetchQuery(pokemonDetailQueryOptions(pokemon.id))
  }
